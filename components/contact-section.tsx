      ...
      <div className="mx-auto max-w-7xl px-6 py-24 lg:px-8">
        ...
        <div className="max-w-2xl">
          ...
          <div className="grid gap-6 sm:grid-cols-2">
            <a
              href="mailto:chanhengmenh@gmail.com"
              className="group flex items-center gap-3 text-foreground transition-colors hover:text-muted-foreground"
            >
              <Mail className="size-5" />
              <span className="text-base md:text-lg">chanhengmenh@gmail.com</span>
            </a>
            <a
              href="https://github.com/chanhengmenh"
              target="_blank"
            ...
            <a
              href="https://linkedin.com/in/chanheng-menh"
              target="_blank"
              rel="noopener noreferrer"
              className="group flex items-center gap-3 text-foreground transition-colors hover:text-muted-foreground"
            >
            ...
            <a
              href="https://chanhengmenh.github.io"
              target="_blank"
              rel="noopener noreferrer"
              className="group flex items-center gap-3 text-foreground transition-colors hover:text-muted-foreground"
            >
